 ...
 * that uses a TmdbMovies object to all the retrieval of additional categories of 
 * info, such as the revenue generated by a referenced by a film in an actor's
 * PersonCredits.
 * @author Pieter Holleman, Zackary Hern, Adam Slifco
 * @version 2
 * @since 7-7-2017
 */
